  ...
  imageList = [
    {
      ...
      content:
        'Mong các bạn hãy cho bé một cơ hội trở thành thành viên trong gia đình bạn',
      image:
        'https://www.hanoipetadoption.com/admin/user-content/Carousel/09f71287-416c-4d28-9532-6a38f1141f1d.jpeg',
    },
    {
      ...
      content:
        'Mong các bạn hãy cho bé một cơ hội trở thành thành viên trong gia đình bạn',
      image:
        'https://www.hanoipetadoption.com/admin/user-content/Carousel/b7ae8a65-6bf9-4fb8-ae3d-635a887ed5ef.jpeg',
    },
  ];
  ...
  newslist = [
    {
      ...
      content:
        'Một nhóm các bạn trẻ tốt bụng ở thành phố Bình Dương đăng ký nhận nuôi một ...',
      image:
        'https://res.cloudinary.com/petrescue/image/upload/h_330,w_330,c_fill,g_face,f_auto,q_auto:best/c_limit,w_700/v1730089127/k4uclwhnqwprdqyqjtjt.jpg',
    },
    {
    ...
    },
    {
      ...
      content:
        'Một đám cháy lớn tại adshfahsf khiến 200 ngừoi bị thương , thiệt hại hơn ...',
      image:
    ...
    },
    {
      title: 'Why can’t I find the rescue organisation I’m looking for?',
      content:
        "Wondering why you can’t find the rescue organisation you're looking for on PetRescue? ",
      image:
        'https://res.cloudinary.com/petrescue/image/upload/c_fill,f_auto,g_face,h_500,q_80,w_500/yfj7e4p5cwnsldya8rkg.jpg',
    },
  ];
